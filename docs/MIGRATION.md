...
4. Rescan real hardware, label each stable ID, and create fixed/locked routes for batch files that represented permanent wiring. Use rules/groups for dynamic routes.
